...
contract VulnerableBankTest is Test {
    ...
    function testReentrancyAttack() public {
        ...
        assertEq(
            ...
            10 ether,
            "Bank should have 10 ether initially"
        );
        assertEq(
            attacker.balance,
            1 ether,
            "Attacker should have 1 ether initially"
        );
        ...
        assertEq(
            address(vulnerableBank).balance,
            0,
            "Bank should have 0 ether after attack"
        );
        assertEq(
            attackerContract.getBalance(),
            11 ether,
            "Attacker contract should have 11 ether after attack"
        );
        ...
        assertEq(
            attacker.balance,
            11 ether,
            "Attacker should end up with 11 ether"
        );
    }
}
